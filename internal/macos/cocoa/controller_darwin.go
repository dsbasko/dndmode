...
type cgoWindowFactory struct {
	...
	language  string  // source language for terminal (go|python|typescript|rust|ys); ignored otherwise
}
...
// typescript|rust|ys, resolved by main.go from the --style terminal:<lang> suffix);
